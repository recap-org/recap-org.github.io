...
- simple build scripts to ensure that steps are run in the correct order.
...
- a build pipeline that ties all components together,
- recorded package environments to ensure long-run reproducibility.
